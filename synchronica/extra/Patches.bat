...
rem language jpn -> eng
util\hexedit app\sync_release.exe app\sync_release.exe 0x00999ACC 0x45,0x4E,0x47 0x4A,0x50,0x4E
...
mklink /H %GAME_DIR%\segatools.ini .\segatools.ini
